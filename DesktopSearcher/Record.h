...
struct DirectoryRecord
{
    ...
    {
        return tools::CodeToUcs2Case(pUcs2,(PBYTE)Name,NameLength&BITMASK_NAMElEN);
    }
...
struct NormalFileRecord
{
    ...
    {
        if(BasicInfo&BITMASK_TWOBYTE_NAMELEN){
			return tools::CodeToUcs2Case(pUcs2, PBYTE(NameInformation + 2), *(WORD*)NameInformation);
        }else{
            return tools::CodeToUcs2Case(pUcs2,PBYTE(NameInformation+1),*NameInformation);
        }
    }
